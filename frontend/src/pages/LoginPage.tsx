            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className="block w-full rounded border border-gray-300 px-3 py-2 pr-10 shadow-sm focus:border-ooosh-500 focus:outline-none focus:ring-1 focus:ring-ooosh-500"
                />
                <button
                  type="button"
