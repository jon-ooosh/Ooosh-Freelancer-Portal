...
**Not started**
- Staff calendar Phase D (sickness & absence, return-to-work, holiday reclaim) — the last phase before the Oct–Dec parallel run. Phases A–C are live. See `docs/STAFF-CALENDAR-SPEC.md` §18 for the build log, the decisions that changed the spec, and the bugs worth not repeating.
