...
11. ✅ **SHIPPED Sep 2026 (staff till)** — see §19. Next: the sitter till, once proved;
    then a PDF receipt (jon wants it — "more receipt-ish" than the email body).
