...
const calculateSchema = z.object({
  ...
  workDurationHrs: z.number().min(0).optional(),
  numDays: z.number().min(1).optional(),
  setupExtraHrs: z.number().min(0).optional(),
  setupPremium: z.number().min(0).optional(),
  travelMethod: z.enum(['vehicle', 'public_transport']).default('vehicle'),
  dayRateOverride: z.number().optional(),
  clientRateOverride: z.number().optional(),
...
const saveQuoteSchema = calculateSchema.extend({
  ...
  addCollection: z.boolean().optional(),
  collectionDate: z.string().optional().nullable(),
  collectionTime: z.string().optional().nullable(),
  clientName: z.string().optional(),
  includesSetup: z.boolean().optional(),
  setupDescription: z.string().optional(),
  workType: z.string().optional(),
  workDescription: z.string().optional(),
  oohManual: z.boolean().optional(),
  earlyStartMins: z.number().optional(),
  lateFinishMins: z.number().optional(),
  internalNotes: z.string().optional(),
  freelancerNotes: z.string().optional(),
});
